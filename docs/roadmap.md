...
| [T0063](tasks/done/T0063-start-screen-reroll-modal.md) | 开始界面改版：随机角色弹窗 | T0056 | [spec](specs/T0063-start-screen-reroll-modal.md) | ✅ |
| [T0065](tasks/done/T0065-dlc-attribute-display.md) | 详细属性面板补全（critDmgMultiplier + DLC passives 动态展示） | T0006, T0019, T0059 | [spec](specs/T0065-dlc-attribute-display.md) | ✅ |
