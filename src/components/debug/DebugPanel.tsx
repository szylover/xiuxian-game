...
import { getAllItemDefs, getAllEquipDefs, getAllTechniqueDefs, getAllDivineArtDefs } from '../../game/registry';
...
export default function DebugPanel({ player, onUpdate }: DebugPanelProps) {
  ...
  const [tab, setTab] = useState<'stats' | 'items' | 'technique' | 'divine'>('stats');
