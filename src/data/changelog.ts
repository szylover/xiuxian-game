...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      '新增 Web Audio API 合成短音效，覆盖修炼、战斗、突破、物品获得、按钮点击与死亡等关键反馈',
      '新增本地持久化音效设置，可在游戏 HUD 中静音和调节音量',
      '新增首次游玩新手引导浮层，介绍修炼、历练、突破核心循环，并可从 HUD 重新打开',
    ],
  },
  {
    version: '1.14.0',
    date: '2026-06-22',
    title: '内容包 CP-02：苟道求真',
    items: [
      '新增苟道流内容包 CP-02，可在开始界面 DLC 列表中勾选加载',
      '新增谨慎生存主题事件、保命丹符材料、苟活防御功法、隐匿妖兽与短任务链',
      '新增隐雾谷、三窟岭、无名小市、影沼泽等区域与苟道主题 NPC',
    ],
  },
  {
    version: '1.13.0',
  ...
  },
  {
    ...
    items: [
      '新增程序化事件生成引擎 — 模板 × 变量词库实时组合，生成大量不重复事件文本和效果（T0070）',
      '新增程序化物品词缀系统 — 随机装备品质变体，战斗后概率掉落程序化装备（T0071）',
      '新增程序化妖兽变体系统 — 境界缩放 + 属性变异，战斗中随机遭遇变体妖兽（T0072）',
      '新增程序化功法词条系统 — 基础功法 + 随机被动词条，学习时生成独特功法实例（T0073）',
      '共享基础设施：确定性 PRNG（Mulberry32）、文本插值引擎、品质抽取逻辑',
      '存档兼容：仅保存 masterSeed + eventCounter，读档按 seed 重新推导',
      '调试面板新增「程序化」标签页：查看种子/计数、重置种子、强制生成事件',
    ],
  },
  {
    version: '1.11.0',
  ...
  },
  {
    ...
    items: [
      '中央区域从「操作按钮 + 日志」改造为场景视图：显示当前区域、NPC、出口、操作',
      '日志改为右侧滑出抽屉（LogDrawer），支持 ESC/遮罩关闭',
      '区域标题栏：显示当前区域名称、描述、安全/危险标签',
      '出口导航：显示父/子/兄弟区域，支持直接前往 + 全图入口',
      'NPC 区域：显示当前区域 NPC 卡片，支持互动 + 人脉总览入口',
      '底部状态栏：瓶颈提示 + 任务追踪 + 日志按钮',
      '右栏世界分组移除地图/NPC 按钮，仅保留任务',
    ],
  },
  {
    version: '1.8.0',
