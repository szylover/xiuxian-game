// ============================================================
// dlc/cp-05-modao/loader.ts — 魔道逆天内容包加载入口
// ============================================================
...
import { CP05_DLC_META } from './manifest';

export async function registerCP05(): Promise<void> {
  const [
    { default: eventsJson },
    { default: itemsJson },
  ...
  const pack = loadEventsFromJson(eventsJson as unknown as JsonEvent[], CP05_DLC_META);
