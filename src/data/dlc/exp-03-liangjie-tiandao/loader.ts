// ============================================================
// dlc/exp-03-liangjie-tiandao/loader.ts — 量劫天道扩展包加载入口
// ============================================================
...
import { EXP03_DLC_META } from './manifest';

export async function registerEXP03(): Promise<void> {
  const [
    { default: eventsJson }, { default: itemsJson }, { default: techniquesJson },
    { default: monstersJson }, { default: regionsJson }, { default: npcsJson }, { default: questsJson },
  ] = await Promise.all([
    import('./events.json'), import('./items.json'), import('./techniques.json'),
    import('./monsters.json'), import('./regions.json'), import('./npcs.json'), import('./quests.json'),
  ]);
  const pack = loadEventsFromJson(eventsJson as unknown as JsonEvent[], EXP03_DLC_META);
  registerDLC({
    ...pack,
