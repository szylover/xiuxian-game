...
export const CP01_BREAKTHROUGH_REQS = loadBreakthroughReqsFromJson(breakthroughReqs);
export const CP01_TRIBULATIONS: TribulationDef[] = tribulations as TribulationDef[];
