// ============================================================
// dlc/exp-04-sect-war/loader.ts — 宗门争霸扩展包加载入口
// ============================================================

import { registerDLC } from '../../../game/registry';
import type { MonsterDef, TechniqueDef, SectDef } from '../../../game/registry';
...
import { EXP04_DLC_META } from './manifest';

export async function registerEXP04(): Promise<void> {
  const [
    { default: eventsJson }, { default: itemsJson }, { default: techniquesJson },
    { default: monstersJson }, { default: regionsJson }, { default: npcsJson },
    { default: questsJson }, { default: sectsJson },
  ] = await Promise.all([
    import('./events.json'), import('./items.json'), import('./techniques.json'),
    import('./monsters.json'), import('./regions.json'), import('./npcs.json'),
    import('./quests.json'), import('./sects.json'),
  ]);
  const pack = loadEventsFromJson(eventsJson as unknown as JsonEvent[], EXP04_DLC_META);
  registerDLC({
    ...pack,
    ...
    sects: sectsJson as unknown as SectDef[],
  });
}
